		...
		<div id="boardList">
			<table>
				...
				<tbody>
						...
						<tr>
							...
							<td class="title">
								<a href="./view_index.php?bno=<?php echo $row['b_no']?>"><?php echo $row['b_title']?></a>
							</td>
			...
			<div class="btnSet">
				<?php 
					if(!$userid) {
				?>
						<br><input type="button" onclick="alertFunction()" class="btnWrite btn" value="글쓰기">
				<?php 
					} else {
				?>
				<br><a href="./write_index.php" class="btnWrite btn">글쓰기</a>
				<?php 
					} 
				?>
			</div>
