		...
		<div id="boardWrite">
			<form action="./write_update.php" method="post">
						...
						<tr>
							...
							<td class="id">
								...
								if(isset($bNo)) {
									...
									<input type="text" name="bID" id="bID" value=<?php echo $userid ?>>
								<?php } ?>
							</td>
						</tr>
						<tr>
							<th scope="row"><label for="bPassword">비밀번호</label></th>
							<td class="password"><input type="password" name="bPassword" id="bPassword" value=<?php echo $userpass ?>></td>
						</tr>
						<tr>
				...
				<div class="btnSet">
					...
					<a href="./question_index.php" class="btnList btn">목록</a>
				</div>
			</form>
		</div>
	</article>
