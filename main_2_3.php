...
<div id="main_content">
	...
	<div class="row">
	<div class="card h">
	<img class="picture1" src="./img/main_2.jpg" alt="1">
	</div>
	</div>
	</div>
	...
	<h4 class="card-title"><p style="font-size:20px">아이튠즈 카드</p><br></h4><br>

	<h5 style="color:orange">30,000원</h5><br>

	<h5 style="color:orange">(우수회원 10% 할인!!)<br>27,000원</h5><br>
	...
	<input type="text" style="display:none" name="card" value="itunescard" READONLY>
