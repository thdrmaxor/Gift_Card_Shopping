...
<div id="main_content">
	...
	<div class="row">
	<div class="card h">
	<img class="picture1" src="./img/main_3.jpg" alt="1">
	</div>
	</div>
	</div>
	...
	<h4 class="card-title"><p style="font-size:20px">플레이스테이션 카드</p><br></h4><br>
	...
	<input type="text" style="display:none" name="card" value="psncard" READONLY>
